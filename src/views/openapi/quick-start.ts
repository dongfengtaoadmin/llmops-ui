export const blockApiShell = `curl --location --request POST 'https://localhost:9000/openapi/chat \\
...
export const streamApiShell = `curl --location --request POST 'https://localhost:9000/openapi/chat \\
--header 'Authorization: Bearer pat_OYDacMzM3WyOWV3Dtj2bHRMymzxP****' \\
--header 'Content-Type: application/json' \\
--data-raw '{
    "app_id": "734829333445931****",
